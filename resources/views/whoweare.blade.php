...
@endsection
@section('content')
<section class="hero who_we_are">
    <div class="container">
        <div class="col-md-6">
            <div class="hero-livebadge mb-3">WHO WE ARE</div>
            <h1 class="hero-title">About SOAPBOX.CLOUD™ — Built by People Who Understand <span class="text-first">What Is at Stake.</span></h1>
            <h3 class="section-sub my-0 mx-auto fs-16 fw-normal">SOAPBOX.CLOUD™ was built by enterprise technology leaders who spent decades inside regulated industries
...
<section class="foundation-hero py-5">
...
<section class="py-5">
    <div class="container max-w-1200">
        ...
        <ul class="nav nav-pills leadership-tabs mb-5 justify-content-center align-items-center" id="leadershipTab" role="tablist">
            <li class="nav-item me-3" role="presentation">
                <button class="nav-link active"
                        id="board-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#board-members"
                        type="button"
                        role="tab">
                    Board Members
                </button>
        ...
        <div class="tab-content" id="leadershipTabContent">
            ...
            <div class="tab-pane fade show active" id="board-members" role="tabpanel">
                                ...
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                            <img src="images/boardmembers/mohdMoizuddin.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <h4 class="fw-semibold fs-18">Mohammed Moizuddin</h4>
                                        <h5 class="small text-primary">Founder</h5>
                                    </div>
                                </div>
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                            <img src="images/boardmembers/RickBrowne.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                            <img src="images/boardmembers/gulaamfarooq.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <h4 class="fw-semibold fs-18">Gulam Farooq Quadir</h4>
                                        <h5 class="small text-primary">Non Executive Director - Business Strategy & Marketing</h5>
                                    </div>
                                </div>
                                <p class="fs-12 text-muted">
                                    Business strategy & consulting expert with deep experience in Oil & Gas, Petrochemical, Construction, Manufacturing, Healthcare industry sectors, and Education & Research, predominantly in MENA region.
                                </p>
                                <a href="https://www.linkedin.com/in/farooqquadir/" class="btn btn-sm btn-third rounded-pill">
                                    <i class="fa-brands fa-linkedin me-1"></i> LinkedIn →
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                                <img src="images/boardmembers/SyedImran.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                            </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                                <img src="images/boardmembers/SyedMazharuddin.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                            </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                                <img src="images/boardmembers/MahaboobAliKhan.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                            </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                                <img src="images/boardmembers/ShaikKhaja.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                            </div>
                                    </div>
                                    <div class="col">
            ...
            <div class="tab-pane fade" id="executive-team" role="tabpanel">
                <div class="row justify-content-center g-4 mb-4 ">
                    <div class="col-md-6 col-lg-4">
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <h4 class="fw-semibold fs-18">Mohammed Moizuddin</h4>
                                        <h5 class="small text-primary">CEO</h5>
                                    </div>
                                </div>
                                <p class="fs-12 text-muted">
                                Over three decades in regulated financial services and enterprise technology. Former IBM Partner and Asia-Pacific Head of Applications. Senior Vice President at DBS Bank. Best of IBM Award 2012. Built SOAPBOX.CLOUD™ from the conviction that safety infrastructure must match the industries it protects.                        </p>
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                                <img src="images/boardmembers/KareemQureshi.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                            </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                                <img src="images/boardmembers/BandaSrikanth.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                            </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="card min-h-350 border rounded-4 p-3 leadership-card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-3">
                                        <div class="initial-box me-3">
                                                <img src="images/boardmembers/SanjaySengupta.webp" alt="Mohammed Moizuddin" class="initial-img" loading="lazy">
                                            </div>
                                    </div>
                                    <div class="col">
...
<section class="guides-hero py-5">
    <div class="container max-w-1200">
